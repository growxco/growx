...
const CLAUSULAS = [
  ...
  },
  {
    ...
    t: 'Objeto',
    p: [
      'Compra e venda, em regime de pré-venda, de 1 (uma) unidade do Módulo Grow-X — central de automação para cultivo indoor com 6 tomadas inteligentes controláveis, controle de fotoperíodo com transições graduais, acionamento de irrigação por leitura de umidade de solo, entradas para sensores ambientais e integração com o aplicativo GXP.',
      ...
      'A pré-venda refere-se a produto que se encontra em fase de industrialização na data da contratação. O CONTRATANTE declara ciência de que está adquirindo produto ainda não disponível em estoque.',
    ],
  },
  {
    n: '3',
  ...
  },
  {
    ...
    p: [
      'Este instrumento é aceito eletronicamente no ato do pagamento; o aceite, a data e a versão do contrato ficam registrados junto ao pedido.',
  ...
  return (
    <div style={{ background: BG }} className="min-h-screen text-white">
      <SEO
        ...
        description="Termos completos da pré-venda do Módulo Grow-X: preço, entrega a partir de 20/11/2026, direito de arrependimento, reembolso integral até o envio e garantia de 1 ano."
      ...
      <div className="mx-auto w-full max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <h1 className="mt-8 text-display-lg font-extrabold text-white">Contrato de pré-venda</h1>
        <p className="mt-4 text-lg" style={{ color: MUTED }}>
          Módulo Grow-X · versão <strong className="text-white">{CONTRATO_VERSAO}</strong> · vigente desde 4 de agosto de 2026
        </p>
        ...
        <div className="mt-14 rounded-2xl border p-6" style={{ borderColor: LINE, background: 'rgba(255,255,255,0.035)' }}>
          <p className="text-sm leading-relaxed" style={{ color: MUTED }}>
            O aceite deste contrato é registrado no momento do pagamento, junto ao seu pedido, com data e versão.
